...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ua_parser_js__ = __webpack_require__(0);
...
var UAParser = __webpack_require__(0);
var parser = new UAParser();
var result = parser.getResult();
console.log(result);
var obj={};
obj.browser = result.browser.name;
obj.browser_ver = result.browser.version;
